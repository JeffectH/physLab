...
public class FirstPersonControllerTim : MonoBehaviour
{
...
// Custom Editor
#if UNITY_EDITOR
    [CustomEditor(typeof(FirstPersonControllerTim)), InitializeOnLoadAttribute]
    public class FirstPersonControllerEditorTim : Editor
    {
    FirstPersonControllerTim fpc;
    SerializedObject SerFPC;

    private void OnEnableTim()
    {
        fpc = (FirstPersonControllerTim)target;
        SerFPC = new SerializedObject(fpc);
    }

    public void OnInspectorGUITim()
    {
        SerFPC.Update();
